"""
	...
	ASSIGNMENT-8 ( The DFT & spectra of periodic functions )
	EE19B049 ( Jahnavi Pragada )
"""
from pylab import *
title_dict = {'cos': r"Spectrum of $cos^3(t)$",'sin': r"Spectrum of $sin^3(t)$",'fm': r"Spectrum of $cos(20t+5cos(t))$",'gauss': r"Spectrum of $\exp(-t^2/2)$"}
func_dict = {'cos' : lambda x : cos(x)**3,'sin' : lambda x : sin(x)**3,'fm' : lambda x : cos(20*x+5*cos(x)),'gauss' : lambda x : exp(-x**2/2) }
